...
const styles = StyleSheet.create({
  ...
  headerDescription: { marginTop: 5, color: '#707070', fontSize: 15, lineHeight: 19, textAlign: 'center' },
  ...
  searchInput: { flex: 1, height: 45, marginLeft: 10, paddingHorizontal: 0, color: '#313131', fontSize: 15 },
  sectionTitle: { marginTop: 27, color: '#111111', fontSize: 19, lineHeight: 24, fontWeight: '800' },
  ...
  trendingTitle: { position: 'absolute', bottom: 8, left: 8, right: 8, color: '#ffffff', fontSize: 14, lineHeight: 18, fontWeight: '700', textAlign: 'center' },
  browseTitle: { marginTop: 28, color: '#111111', fontSize: 19, lineHeight: 24, fontWeight: '800' },
  ...
  eventTitle: { color: '#202124', fontSize: 16, lineHeight: 20, fontWeight: '800' },
  ratingRow: { marginTop: 8, flexDirection: 'row', alignItems: 'center' },
  ratingText: { marginLeft: 6, color: '#707070', fontSize: 14, lineHeight: 18 },
